...
namespace CryptoCurrency
{
    internal static class MinerWallet
    {
        internal static void Load()
        {
            ...
            {
                "https://localhost:5001/" => miner0,
                "https://mysterious-thicket-34741.herokuapp.com/" => miner1,
                "https://limitless-sands-00250.herokuapp.com/" => miner2,
                "http://190.231.194.136/" => miner3,
                "http://190.231.194.136:8081/" => miner4,
                _ => miner0,
            };
        }
    }
